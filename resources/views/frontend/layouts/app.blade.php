...
<body class="direction-ltr">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-grid-product">
                        ...
                        <div class="product-info text-center">
                            ...
                            <input type="hidden" name="quantity" value="1" id="product_quantity">
                            <h3 class="product-name"><a class="product-link"
                                    href="/product/single/rosmo-namino-2">Rosmo
                                    Namino</a>
                            </h3>
                            <!-- This is server side code. User can not modify it. -->
                            <ul class="product-review">
    ...
    <div class="trending-products-area section-top pb-100">
        <div class="container">
                            ...
                            <ul class="nav nav-tabs" id="TrendingProducts" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="on-sell-tab" data-bs-toggle="tab"
                                        data-bs-target="#on-sell" type="button" role="tab"
                                        aria-controls="on-sell" aria-selected="false">ON SALE</button>
                                </li>
                                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="TrendingProductsContent">
                ...
                <div class="tab-pane fade " id="featured-items" role="tabpanel"
                    aria-labelledby="featured-items-tab">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-grid-product">
                                <div class="product-top">
                            ...
                            <div class="newsletter-form mb-40">
                                <form id="subscribe_form" name="subscribe_form" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button"
                                            class="subscribe-btn subscribe_btn">Subscribe</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <div class="modal fade common-modal" id="trackOrderModal" tabindex="-1"
